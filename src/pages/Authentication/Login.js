                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2">
                                            <Form
                                                ...
                                                {/*        <Link*/}
                                                {/*            to="#"*/}
                                                {/*            className="btn btn-facebook btn-icon me-1"*/}
                                                {/*            onClick={e => {*/}
                                                {/*                e.preventDefault();*/}
                                                ...
                                                {/*               className="ri-facebook-fill icon-white fs-16"/>*/}
                                                {/*        </Link>*/}
                                                {/*        <Link*/}
                                                {/*            to="#"*/}
                                                {/*            className="btn btn-google btn-icon me-1"*/}
                                                {/*            onClick={e => {*/}
                                                {/*                e.preventDefault();*/}
                                                ...
                                                {/*               className="ri-google-fill icon-white fs-16"/>*/}
                                                {/*        </Link>*/}
                                ...
                                {/*                                                      className="fw-semibold text-info-emphasis text-decoration-underline"> Signup </Link>*/}
                                {/*    </p>*/}
                                {/*</div>*/}
